...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Main-DebugLog",intent.getStringExtra("email"));
...
//        }
    ...
    private void setContent(){
        ...
        asyncDownload.execute("https://i.imgur.com/H2qAtxq.jpg");

        seeder.seed();
        User user = seeder.userList.get(intent.getStringExtra("email"));
        Log.d("Main-DebugLog",user.getEmail() + "-" + user.getUsername());

        NavigationView navigationView = findViewById(R.id.nav_view);
        View headerView = navigationView.getHeaderView(0);

        TextView tvUsername = headerView.findViewById(R.id.tvUsername);
        tvUsername.setText("[" + user.getBadge() + "] " + user.getUsername());
